...
var uni_modules_vkUviewUi_components_uParse_libs_MpHtmlParser = require("./libs/MpHtmlParser.js");
require("./libs/config.js");
require("./libs/CssHandler.js");
...
const _sfc_main = {
  ...
  methods: {
    setContent(html, append) {
      ...
      if (!html)
        return this.nodes = [];
      var parser = new uni_modules_vkUviewUi_components_uParse_libs_MpHtmlParser.MpHtmlParser(html, this);
      if (this.useCache) {
    ...
    getText(ns = this.nodes) {
      ...
      for (var i = 0, n; n = ns[i++]; ) {
        if (n.type == "text")
          txt += n.text.replace(/&nbsp;/g, "\xA0").replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&amp;/g, "&");
        else if (n.type == "br")
          txt += "\n";
        else {
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "F:/\u4E0A\u8BFE\u4FDD\u5B58\u7684\u6587\u4EF6/P5/P8/BestBuy-mall/uni_modules/vk-uview-ui/components/u-parse/u-parse.vue"]]);
