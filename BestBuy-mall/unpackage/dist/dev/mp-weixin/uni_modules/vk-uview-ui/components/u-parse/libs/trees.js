...
var uni_modules_vkUviewUi_components_uParse_libs_config = require("./config.js");
var inline = {
  abbr: 1,
  b: 1,
  big: 1,
...
const trees = () => Promise.resolve().then(function() {
  return Rjov5LiK6K_5LD5a2Y55qE5paH5Lu2L1A1L1A4L0Jlc3RCdXktbWFsbC91bmlfbW9kdWxlcy92ay11dmlldy11aS9jb21wb25lbnRzL3UtcGFyc2UvbGlicy90cmVlcy52dWU;
});
    ...
    init() {
      for (var i = this.nodes.length, n; n = this.nodes[--i]; ) {
        if (n.name == "img") {
          ...
          var ctx;
          if (n.name == "video") {
            ctx = common_vendor.index.createVideoContext(n.attrs.id, this);
  ...
  return {
    a: common_vendor.f($props.nodes, (n, i, i0) => {
      return common_vendor.e({
        ...
        g: i,
        h: n.attrs.i,
        i: common_vendor.o((...args) => $options.loadImg && $options.loadImg(...args)),
        ...
        m: n.attrs,
        n: common_vendor.o((...args) => $options.imgtap && $options.imgtap(...args))
      }) : n.type == "text" ? {
        ...
        w: i,
        x: common_vendor.o((...args) => $options._loadVideo && $options._loadVideo(...args))
      } : n.name == "video" ? {
        z: n.attrs.id,
        ...
        J: n.attrs.id,
        K: i,
        L: common_vendor.o((...args) => $options.error && $options.error(...args)),
        M: common_vendor.o((...args) => $options.play && $options.play(...args))
      } : n.name == "audio" ? {
        O: n.attrs.id,
        ...
        ai: n.attrs,
        aj: common_vendor.o((...args) => $options.linkpress && $options.linkpress(...args))
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "F:/\u4E0A\u8BFE\u4FDD\u5B58\u7684\u6587\u4EF6/P5/P8/BestBuy-mall/uni_modules/vk-uview-ui/components/u-parse/libs/trees.vue"]]);
wx.createComponent(Component);
var Rjov5LiK6K_5LD5a2Y55qE5paH5Lu2L1A1L1A4L0Jlc3RCdXktbWFsbC91bmlfbW9kdWxlcy92ay11dmlldy11aS9jb21wb25lbnRzL3UtcGFyc2UvbGlicy90cmVlcy52dWU = /* @__PURE__ */ Object.freeze({
  __proto__: null,
